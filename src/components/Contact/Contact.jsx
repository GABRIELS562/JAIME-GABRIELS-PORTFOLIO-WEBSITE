    ...
    <section id="contact" className={styles.contactSection}>
      <div className={styles.contactCard}>
        ...
        <div className={styles.contactList}>
          <a href="mailto:info@jagdevops.com" className={styles.contactItem}>
            <div className={styles.contactContent}>
              ...
              <div className={styles.contactDetails}>
                ...
                <span className={styles.contactValue}>info@jagdevops.com</span>
              </div>
            </div>
          ...
          <a href="https://www.linkedin.com/in/jaime-gabriels-643132386" target="_blank" rel="noopener noreferrer" className={styles.contactItem}>
            <div className={styles.contactContent}>
              ...
              <div className={styles.contactDetails}>
                ...
                <span className={styles.contactValue}>Professional Network</span>
              </div>
            </div>
            <span className={styles.contactAction}>→</span>
          </a>

          <a href="https://github.com/GABRIELS562" target="_blank" rel="noopener noreferrer" className={styles.contactItem}>
            <div className={styles.contactContent}>
              <div className={styles.contactIcon}>
                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
              ...
              <div className={styles.contactDetails}>
                ...
                <span className={styles.contactValue}>View My Projects</span>
              </div>
            </div>
            <span className={styles.contactAction}>→</span>
          </a>
