      ...
      <div className={styles.footerContent}>
        ...
        <div className={styles.socialSection}>
          ...
          <div className={styles.socialLinks}>
            <a href="https://github.com/GABRIELS562" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
            ...
            <a href="https://linkedin.com/in/jaime-gabriels" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
